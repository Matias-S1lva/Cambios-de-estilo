var Forms = function(){
    ...
    this.paginaInicial=function(){
         var text = "<img src='FONDO2.webp'  class='portada'/>";
    ...
    this.altaAlumno = function(){
       ...
       if(G.id("form2") != null)
       {
         var img = 'src="ATRAS1.png"';
       }
       else img = 'src="ATRAS.png"';
       var text =   
       '<form class="form">'+
...
var makeListAlumnos = function(){
   ...
   var text = '<div class="tabla__contenedor"><h3 class="tabla__titulo">LISTADO DE ALUMNOS <img src="BORRAR.png" class="tabla__icono" onclick="F.paginaInicial();"/></h3>'+
                    '<table class="tabla">'+
